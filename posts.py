...
class Posts(object):
    ...
    def send_post(self, img: str, text:str, tags: List[str]):
        ...
        new_post = driver.find_element_by_xpath("/html/body/div[1]/section/nav[2]/div/div/form/input")
        self.click(driver.find_element_by_xpath("/html/body/div[1]/section/nav[2]/div/div/div[2]/div/div/div[3]"))
